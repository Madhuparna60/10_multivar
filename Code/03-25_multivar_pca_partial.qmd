...
```{r}
weather <- read.csv("../../09_opendata/Data/weather_monthsum.csv")
...
```
Vif = higher (highly multicollinearity)
vif = less
...
PCs 1 and 2 explain \~35% and \~26% (61%) of total variance. This indicates that original variables were correlated (as we expected).
